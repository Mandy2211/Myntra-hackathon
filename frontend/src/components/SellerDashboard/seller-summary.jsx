...
export default function SellerSummary({ categoryData }) {
  ...
  return (
    <div className="bg-gradient-to-br from-purple-900/30 to-pink-900/20 border border-purple-500/30 rounded-2xl p-6 mb-8 relative">
      <div className="absolute top-0 right-0 bg-pink-600 text-slate-900 dark:text-white text-[10px] font-bold px-3 py-1 rounded-bl-xl flex items-center gap-1">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
        ...
        <div className="relative" ref={dropdownRef}>
          <button
            ...
            className="flex items-center gap-2 text-xs bg-white dark:bg-slate-900/90 hover:bg-slate-100 dark:bg-slate-800 border border-purple-500/40 text-slate-800 dark:text-slate-200 px-3.5 py-2 rounded-xl transition-all shadow-lg focus:outline-none"
          >
          ...
          {dropdownOpen && (
            <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl shadow-2xl z-50 py-1.5 backdrop-blur animate-in fade-in slide-in-from-top-2">
              <div className="px-3 py-1 text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 border-b border-slate-200 dark:border-slate-800 mb-1">
